...
const VisitorPolicy = () => {
    return (
        ...
        <h4 className="d-flex justify-content-center text-secondary">VISITORS POLICY AIMED AT PATIENTS’ SAFETY</h4>
            <p className="ps-2">Dear Visitors
        ...
        <h4 className="ps-2">PATIENT VISITING HOUR:  4.00 pm to 7.00 pm</h4>
        <br /><br />
       <h5 className="ps-2">
       ...
       <br />
       <h5 className="ps-2">MORNING    : 9.30 am to 10.30 am
       AFTERNOON    : 5.30 pm to 7.00 pm</h5>
       <br /><br /><br />
       <p className="ps-2">We urge you to avoid bringing children below 07 years old to the hospital. This is in the interest of their safety as they are more vulnerable to infection. Persons who are unwell must not visit any patient.
